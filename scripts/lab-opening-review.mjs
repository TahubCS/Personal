...
const directory = `artifacts/motion-lab/opening/${version}`;
...
for (const viewport of [
  ...
  for (const progress of [0, 0.15, 0.25, 0.32, 0.4, 0.48, 0.56, 0.6, 1]) {
...
console.log(
  `${version}: eighteen matched frames captured; no console/page errors.`,
);
