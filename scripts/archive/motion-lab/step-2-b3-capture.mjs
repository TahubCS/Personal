...
const directory = 'artifacts/motion-lab/step-2-b3';
...
for (const viewport of [
  ...
  const progressPoints = viewport.name === 'desktop-1440' ? [0.00, 0.74, 1.00] : [1.00];
...
console.log('Captures completed for Step 2.B3; errors:', errors.length);
