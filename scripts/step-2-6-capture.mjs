...
const directory = 'artifacts/motion-lab/step-2-6';
...
for (const viewport of [
  ...
  for (const progress of [0.60, 0.68, 0.76, 0.84, 0.92]) {
...
console.log('Captures completed for Step 2.6; errors:', errors.length);
